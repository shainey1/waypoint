...
export const metadata: Metadata = {
  title: "Golf in Denver — Waypoint",
  description:
    "The complete guide to golf in Denver, Colorado. Courses, driving ranges, pro shops, communities, and insider tips for recent movers.",
};

export default function DenverGolfPage() {
  const city = getCity("denver");
  const activity = getActivity("golf");
  const guide = getGuide("denver", "golf");
      ...
      <main className="pt-16">
        ...
        <div className="max-w-6xl mx-auto px-6 py-16">
          ...
          <SectionHeading
            ...
            number="01"
            title="Where to Play"
            subtitle="Courses organized by difficulty, from beginner-friendly munis to championship layouts."
          />
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm text-gray-500">
                Forgiving courses for getting started
              </span>
            </div>
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm text-gray-500">
                More challenge once you&apos;ve got your swing
              </span>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm text-gray-500">
                Championship courses that test your game
              </span>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="section-divider">
            <SectionHeading
              ...
              subtitle="Golf at altitude and in the Rocky Mountain climate has its quirks. Here's what to expect."
            />
          ...
          {venues.length > 0 && (
            <div className="section-divider">
              <SectionHeading
                ...
                subtitle="Driving ranges and practice facilities around Denver."
              />
          ...
          <div className="section-divider">
            <SectionHeading
              ...
              subtitle="Where to buy clubs, get fitted, and find deals on equipment."
            />
          ...
          <div className="section-divider">
            <SectionHeading
              id="communities"
              number="05"
              title="Communities & Leagues"
              subtitle="Find playing partners and join the Denver golf community."
            />
          ...
          <div className="section-divider">
            <SectionHeading
              ...
              subtitle="The tools Denver golfers actually use."
            />
          ...
          <div className="section-divider">
            <SectionHeading
              ...
              number="07"
              title="Insider Tips"
              subtitle="Local knowledge that only comes from playing here."
            />
