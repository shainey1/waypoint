...
export const metadata: Metadata = {
  title: "Hiking in Denver — Waypoint",
  description:
    "The complete guide to hiking in Denver, Colorado. Trails, 14ers, gear shops, communities, and insider tips for recent movers.",
};

export default function DenverHikingPage() {
  const city = getCity("denver");
  const activity = getActivity("hiking");
  const guide = getGuide("denver", "hiking");
      ...
      <main className="pt-16">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto px-6 pt-24 pb-12 sm:pt-32 sm:pb-16 relative">
            ...
            <div className="flex items-center gap-2 text-sm text-gray-500 mb-8">
              ...
              <span>/</span>
              <span className="text-gray-300">Hiking</span>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6 py-16">
          ...
          <SectionHeading
            ...
            number="01"
            title="Where to Go"
            subtitle="Trails organized by difficulty, from your first Front Range hike to your first 14er."
          />
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm text-gray-500">
                Start here your first few weeks
              </span>
            </div>
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm text-gray-500">
                Once you&apos;ve acclimatized (2–4 weeks)
              </span>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm text-gray-500">
                14ers and technical routes — build up to these
              </span>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="section-divider">
            <SectionHeading
              ...
              subtitle="Colorado hiking isn't like hiking anywhere else. Here's what catches newcomers off guard."
            />
          ...
          <div className="section-divider">
            <SectionHeading
              ...
              subtitle="Where Denver hikers buy, rent, and get advice on gear."
            />
          ...
          <div className="section-divider">
            <SectionHeading
              ...
              subtitle="Where to meet other hikers and find trail partners in Denver."
            />
          ...
          <div className="section-divider">
            <SectionHeading
              ...
              subtitle="The tools Denver hikers actually use."
            />
          ...
          <div className="section-divider">
            <SectionHeading
              ...
              number="06"
              title="Insider Tips"
              subtitle="Local knowledge that only comes from living here."
            />
          ...
          <div className="section-divider">
            <SectionHeading
              ...
              number="08"
              title="New to Hiking?"
              subtitle="Your first-week checklist for getting started in Colorado."
            />
                ...
                {guide.beginnerChecklist.map((item, i) => (
                  ...
                  >
                    <div className="mt-0.5 w-5 h-5 shrink-0 rounded border-2 border-gray-700 group-hover:border-accent-600 transition-colors flex items-center justify-center">
                      {/* Checkbox is visual only — no state needed for MVP */}
                    </div>
