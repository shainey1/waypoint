...
export const metadata: Metadata = {
  title: "Running in Denver — Waypoint",
  description:
    "The complete guide to running in Denver, Colorado. Urban paths, trail running, tracks, running clubs, and insider tips for recent movers.",
};

export default function DenverRunningPage() {
  const city = getCity("denver");
  const activity = getActivity("running");
  const guide = getGuide("denver", "running");
  ...
  const venues = guide.spots.filter((s) => s.type === "venue");
      ...
      <main className="pt-16">
        ...
        <div className="max-w-6xl mx-auto px-6 py-16">
          ...
          <SectionHeading
            ...
            number="01"
            title="Where to Run"
            subtitle="Urban paths, parks, and trail running organized by difficulty."
          />
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm text-gray-500">
                Flat paths and parks — start here while acclimating
              </span>
            </div>
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm text-gray-500">
                Trail running and more challenging terrain
              </span>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm text-gray-500">
                Mountain trails and long-distance routes
              </span>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="section-divider">
            <SectionHeading
              ...
              subtitle="Running at altitude with world-class trails and 300 days of sun."
            />
          ...
          {venues.length > 0 && (
            <div className="section-divider">
              <SectionHeading
                id="tracks"
                number="03"
                title="Tracks & Speedwork"
                subtitle="Where to do intervals and structured workouts."
              />

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {venues.map((venue) => (
                  <SpotCard key={venue.name} spot={venue} />
                ))}
              </div>
            </div>
          )}
          ...
          <div className="section-divider">
            <SectionHeading
              id="gear-shops"
              number="04"
              title="Local Running Shops"
              subtitle="Where Denver runners buy shoes and gear."
            />
          ...
          <div className="section-divider">
            <SectionHeading
              ...
              subtitle="Find running partners and join the Denver running community."
            />
          ...
          <div className="section-divider">
            <SectionHeading
              ...
              subtitle="The tools Denver runners actually use."
            />
          ...
          <div className="section-divider">
            <SectionHeading
              ...
              number="07"
              title="Insider Tips"
              subtitle="Local knowledge that only comes from running here."
            />
          ...
          <div className="section-divider">
            <SectionHeading
              ...
              subtitle="What to expect and when throughout the year."
            />
          ...
          <div className="section-divider">
            <SectionHeading
              id="getting-started"
              number="09"
              title="New to Running in Denver?"
              subtitle="Your first-week checklist for getting started at altitude."
            />
